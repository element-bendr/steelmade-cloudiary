...
if (Array.isArray(miniMarksonExecutiveChair.variants)) {
...
(miniMarksonExecutiveChair as any).images = Array.isArray(miniMarksonExecutiveChair.variants) ? miniMarksonExecutiveChair.variants.map(v => v.imageUrl) : [];
(miniMarksonExecutiveChair as any).imageUrl = Array.isArray(miniMarksonExecutiveChair.variants) ? (miniMarksonExecutiveChair.variants.find(v => v.id === 'rev')?.imageUrl || miniMarksonExecutiveChair.variants[0]?.imageUrl) : undefined;
