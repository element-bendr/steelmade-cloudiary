...
import { Product, ProductCategory, ChairSeries } from '@/modules/product/types';
...
export default async function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  // Use the new ProductService to fetch data
  const productService = ProductService.getInstance();
  const product = await productService.getProductByCategoryAndSeries(
    ProductCategory.CHAIRS,
    ChairSeries.DIRECTOR,
    productId
  );
